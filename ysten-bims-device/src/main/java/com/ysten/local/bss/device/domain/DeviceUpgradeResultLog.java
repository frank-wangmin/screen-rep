...
public class DeviceUpgradeResultLog implements java.io.Serializable{

	private static final long serialVersionUID = 2429405723273787132L;
	...
	public EnumConstantsInterface.UpgradeResultStatus getStatus() {
		return status;
	}
	public void setStatus(EnumConstantsInterface.UpgradeResultStatus status) {
		this.status = status;
	}
