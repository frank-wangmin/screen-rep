...
<script type="text/javascript">
$(function(){
	$("#panel_package_list").attr("height",(rFrameHeight+60)+'px');
...
<body>
  <div id="container">
		<div class="pane ui-layout-center" style="overflow: hidden">
      	<iframe id="panel_package_list" name="panel_package_list" src="to_panel_package_list.shtml" width="100%"  border=0 frameBorder='no' scrolling="no"></iframe>
      </div>
		<div class="pane ui-layout-east" style="overflow: hidden">
      	<iframe id="panel_list" name="panel_list" src="to_panel_list_by_package.shtml" width="100%"  border=0 frameBorder='no' scrolling="no"></iframe>
      </div>
	</div>				
</body>
</html>
